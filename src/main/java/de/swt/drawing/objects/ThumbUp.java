...
public class ThumbUp extends DrawableObject {
    private int width;
    private transient FontIcon icon;

    public ThumbUp(int x, int y, Color color, double scale, String description) {
    ...
    private void setupIcon(){
        icon = new FontIcon();
        icon.setIkon(MaterialDesignT.THUMB_UP);
    }
