...
public class DrawablePanel extends GUI {
    ...
    public void setupListeners() {
        switch (getGuiManager().getAccountType()) {
            case STUDENT -> setupPopupBelow(showTaskButton, showTaskPanel);
            case TEACHER -> setupPopupBelow(taskButton, new CreateTaskPanel(getGuiManager()));
        }
    }
    ...
    public DrawableObject[] getDrawnObjects() {
        ...
        return objects.toArray(new DrawableObject[0]);
    }
